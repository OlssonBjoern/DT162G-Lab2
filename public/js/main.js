...
function getSingleCourse(id) {
    $.ajax({
        ...
        url:"http://localhost:3000/courses/course/" + id
            ...
            $("#editformdiv").html(
                "<h1>Redigera "+ response.courseId +"</h1><form class='editform' method='POST' action='http://localhost:3000/courses/course/update/"+ response._id + "'><input type='text' name='editedCourseId' id='editedCourseId' placeholder='"+ response.courseId+"'><br><br><input type='text' name='editedCourseName' id='editedCourseName' placeholder='"+ response.courseName+"'><br><br><input type='text' name='editedCoursePlan' id='editedCoursePlan' placeholder='"+ response.coursePlan+"'><br><br><input type='text' name='editedCourseProgression' id='editedCourseProgression' placeholder='"+ response.courseProgression+"'><br><br><input type='text' name='editedCourseSemester' id='editedCourseSemester' placeholder='"+ response.courseSemester+"'><br><br><input type='submit' value='Edit course'></form>"
            );
            //Prefill form
